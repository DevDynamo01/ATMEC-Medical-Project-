...
appointment_routes.route('/appointments/docter', methods=['GET'])(get_docters_all_appointments)   # { docter_id }
appointment_routes.route('/appointments/user', methods=['GET'])(get_users_all_appointments)   # { user_id }